...
## Phase 0: SDR Foundation

### 0. SDR Scope Definition and Planning (Project Manager)
```
Your role: Project Manager
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md

Task: Define SDR scope and establish validation approach for system design feasibility

Execute exactly:
1. Define SDR objectives and success criteria
2. Establish proof-of-concept and validation requirements
3. Identify critical technology and architecture decisions requiring validation
4. Define risk tolerance and mitigation requirements
5. Establish evidence standards for design decisions

Create: evidence/sdr-actual/00_sdr_scope_definition.md

DELIVERABLE CRITERIA:
- SDR objectives: Clear goals for design validation and feasibility proof
- Validation requirements: Specific proof-of-concept and testing criteria
- Critical decisions: Technology and architecture choices requiring evidence
- Risk framework: Acceptable risk levels and required mitigation approaches
- Evidence standards: Required proof for design decision authorization
- Task incomplete until ALL criteria met

Success confirmation: "SDR scope defined with clear validation requirements and evidence standards"
```

## Phase 1: Requirements Baseline

### 1. Requirements Validation and Baseline (IV&V)
```
Your role: IV&V
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md
...
Input: evidence/sdr-actual/00_sdr_scope_definition.md
...
Create: evidence/sdr-actual/01_requirements_validation.md
...
### 1a. Requirements Baseline Gate Review (Project Manager)
```
Your role: Project Manager
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md

Input: evidence/sdr-actual/01_requirements_validation.md
...
Create: evidence/sdr-actual/01a_requirements_gate_review.md
...
### 2. High-Level Architecture Design (Developer)
```
Your role: Developer
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md
...
Create: evidence/sdr-actual/02_architecture_design.md
...
### 3. Interface Definition and Validation (Developer)
```
Your role: Developer
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md
...
Create: evidence/sdr-actual/03_interface_validation.md
...
### 4. Technology Spike Validation (Developer)
```
Your role: Developer
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md
...
Create: evidence/sdr-actual/04_technology_validation.md
...
### 4a. Architecture Feasibility Gate Review (Project Manager)
```
Your role: Project Manager
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md

Input: evidence/sdr-actual/02_architecture_design.md, 03_interface_validation.md, 04_technology_validation.md
...
Create: evidence/sdr-actual/04a_architecture_feasibility_gate_review.md
...
If PROCEED: Authorize Phase 3 risk and integration assessment
```

---

## Phase 3: Risk and Integration Assessment

### 5. Risk Assessment and Mitigation Planning (IV&V)
```
Your role: IV&V
Ground rules: docs/development/project-ground-rules.md
Role reference: docs/development/roles-responsibilities.md
