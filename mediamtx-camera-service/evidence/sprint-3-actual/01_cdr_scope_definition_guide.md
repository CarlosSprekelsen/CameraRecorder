...
Deliverable: Gate decision with justification and any required remediation scope.
```
...
If REMEDIATE: Return to Developer with specific requirements
...
If REMEDIATE: Return to Developer with specific issue resolution scope
...
If REMEDIATE: Return to Developer/IV&V with specific system issue resolution scope
...
If REMEDIATE: Return to Developer/IV&V with specific production issue resolution scope
