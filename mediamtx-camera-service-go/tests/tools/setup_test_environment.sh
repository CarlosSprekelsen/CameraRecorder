...
# JWT Configuration (REQUIRED for tests)
export CAMERA_SERVICE_SECURITY_JWT_SECRET_KEY="$(generate_jwt_secret)"

# Server Configuration (REQUIRED for tests)
export CAMERA_SERVICE_SERVER_WEBSOCKET_PATH="/ws"

# MediaMTX Configuration (REQUIRED for tests - STANAG compliance)
export CAMERA_SERVICE_MEDIAMTX_CODEC_VIDEO_PROFILE="main"
