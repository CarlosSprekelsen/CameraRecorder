...
/*
WebSocket method integration tests.

Tests validate actual method implementations with real components against ground truth API documentation.
...
// TestPingMethodIntegration tests ping method with real components
func TestPingMethodIntegration(t *testing.T) {
	/*
		Integration Test for ping method with real components
...
// TestAuthenticateMethodIntegration tests authenticate method with real components
func TestAuthenticateMethodIntegration(t *testing.T) {
	/*
		Integration Test for authenticate method with real components
...
// TestGetCameraListMethodIntegration tests get_camera_list method with real components
func TestGetCameraListMethodIntegration(t *testing.T) {
	/*
		Integration Test for get_camera_list method with real components
	...
	*/
	...
	// Note: cameras array may be empty if no cameras are connected, which is valid

	// Validate performance target
	assert.Less(t, responseTime, 50*time.Millisecond, "Get camera list response should be <50ms per API documentation")
}

// TestGetCameraStatusMethodIntegration tests get_camera_status method with real components
func TestGetCameraStatusMethodIntegration(t *testing.T) {
	/*
		Integration Test for get_camera_status method with real components
...
// TestAuthenticationRequiredErrorIntegration tests authentication error handling with real components
func TestAuthenticationRequiredErrorIntegration(t *testing.T) {
	/*
		Integration Test for authentication error handling with real components
...
// TestInvalidParametersErrorIntegration tests invalid parameters error handling with real components
func TestInvalidParametersErrorIntegration(t *testing.T) {
	/*
		Integration Test for invalid parameters error handling with real components
	...
	*/
	...
	// Try to call get_camera_status with missing device parameter
