...
func TestSessionManager_SessionLifecycle(t *testing.T) {
	...
	session := testtestutils.CreateTestSession(t, env.SessionManager, "test_user", security.RoleAdmin)
...
func TestSessionManager_Concurrency(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		go func(id int) {
			...
			session := testtestutils.CreateTestSession(t, env.SessionManager, userID, security.RoleViewer)
...
func TestSessionManager_EdgeCases(t *testing.T) {
	...
	t.Run("invalidate_user_sessions", func(t *testing.T) {
		...
		testtestutils.CreateTestSession(t, env.SessionManager, "multi_user", security.RoleViewer)
		testtestutils.CreateTestSession(t, env.SessionManager, "multi_user", security.RoleOperator)

		// Create session for different user
		testtestutils.CreateTestSession(t, env.SessionManager, "other_user", security.RoleAdmin)
	...
	t.Run("session_with_special_characters", func(t *testing.T) {
		...
		testtestutils.CreateTestSession(t, env.SessionManager, specialUserID, security.RoleAdmin)
	...
	t.Run("session_activity_tracking", func(t *testing.T) {
		session := testtestutils.CreateTestSession(t, env.SessionManager, "activity_user", security.RoleOperator)
