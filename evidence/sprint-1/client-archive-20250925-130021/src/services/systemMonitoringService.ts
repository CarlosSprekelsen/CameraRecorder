...
export class SystemMonitoringService {
  ...
  public async getSystemStatus(): Promise<SystemStatus> {
    ...
    try {
      ...
      const response = await this.wsService.call(RPC_METHODS.GET_STATUS, {});
  ...
  public async getServerInfo(): Promise<ServerInfo> {
    ...
    try {
      ...
      const response = await this.wsService.call(RPC_METHODS.GET_SERVER_INFO, {});
  ...
  public async getSystemMetrics(): Promise<SystemMetrics> {
    ...
    try {
      ...
      const response = await this.wsService.call(RPC_METHODS.GET_METRICS, {});
